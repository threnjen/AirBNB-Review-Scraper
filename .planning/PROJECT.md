...
- ✓ ADR values captured per property in `outputs/05_details_results/property_amenities_matrix_cleaned_97067.csv` — existing
...
- **Data source:** `outputs/05_details_results/property_amenities_matrix_cleaned_97067.csv`
