...
def locationer(postal_code, iso_code= "us"):
    ...
    try:
        ...
        if "is not a known country code" in str(e):  # Checks if the error is due to an unknown ISO code
            print(f"The code {iso_code} has no available data. Please select a different ISO code.")
        else:
