...
def airbnb_scraper():
    ...
    with open('search_results.json', 'w', encoding='utf-8') as f:
        f.write(json.dumps(search_results, ensure_ascii = False))  # Convert results to JSON and write to file
    ...
    for id in room_ids:
        ...
        print(f"I scraped {len(single_property_formatted_reviews)} reviews for this listing")
    ...
    with open('reviews.json', 'w', encoding='utf-8') as f:
        f.write(json.dumps(review_results, ensure_ascii = False))  # Extract reviews and save them to a file
